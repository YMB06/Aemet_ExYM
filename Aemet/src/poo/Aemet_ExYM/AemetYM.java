...
public class AemetYM {
    ...
    static RegCiudadYM[] registroTempYM = new RegCiudadYM[NCIUDADESYM];
    ...
    public static void GenerarRegistroTempYM() {
        for (int i = 0; i < NCIUDADESYM; i++) {
            ...
            int tmin = sc.nextInt();
            registroTempYM[i] = new RegCiudadYM(nombresYM[i], tmax, tmin);
        }
    }

    // Método para listar el registro de temperaturas
    public static void ListarRegistroTempYM() {
        for (RegCiudadYM ciudadYM : registroTempYM) {
